...
type AliasOpt struct {
	...
	Type     AliasValueType `yaml:"type,omitempty" json:"type,omitempty"`
...
type Alias struct {
	Name     string     `yaml:"name,omitempty" json:"name,omitempty"`
	Options  []AliasOpt `yaml:"options,omitempty" json:"options,omitempty"`
	Args     []AliasArg `yaml:"args,omitempty" json:"args,omitempty"`
...
type AliasValueType int

const (
	DEFAULT AliasValueType = iota
	BOOL
	COUNTER
	FLOAT32
	FLOAT64
...
func (o *AliasValueType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var optType string
